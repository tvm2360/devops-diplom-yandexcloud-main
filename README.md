...
Проект тестового приложения находится в группе docker:

![Test_Project](./pictures/Test_Project.png)

Проведем тестирования развертывания приложения из добавляемых тегов. Формирование образа контейнера и выгрузка в регистри стартовала сразу после загрузки проекта:

![Test_Push_Master](./pictures/Test_Push_Master.png)

Добавим автоустановку призанака "Protected" на добавляемые теги:
...
После добавления тега запустился job push_tag_and_deploy:

![Test_Start_Push_and_Deploy](./pictures/Test_Start_Push_and_Deploy.png)

В логах выгрузка образа в регистри:
